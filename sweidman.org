...
** jedi
   - Install virtualenv and activate it. jedi requires VIRTUAL_ENV to be set.
   - Run 'make requirements' in the elpa/jedi directory
** pyflakes
...
Python completion and code assist for emacs
...
(setq pylookup-dir "~/.emacs.d/externals/pylookup")
